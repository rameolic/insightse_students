...
class LightColor {
  ...
  static const Color yellow1 = Color(0xffffff00);
  static const Color yellow2 = Color(0xffffff4d);
  static const Color yellow3 = Color(0xffffff9a);
  static const Color yellow4 = Color(0xffffff67);
