                                                          ...
                                                          onTap: () async {
                                                            ...
                                                            for (int i = 0;
                                                              ...
                                                              print(
                                                                  "Id: $current_userid");
                                                              print(
                                                                  "login Id: ${Logindata.userid}");
                                                              print(
                                                                  "parent Id: ${Logindata.parentid}");
                    ...
                    ValueListenableBuilder<bool>(
                        ...
                        builder: (context, value, child) {
                          return ProgressHUD(
                            ...
                            child: FutureBuilder(
                                future: getmessages(
                                    receiverid, skip.toString(), context),
                                  ...
                                  if (platformData.hasData) {
                                    ...
                                    if (socketstatus) {
                                      ...
                                      channel.stream.listen((event) async {
                                        ...
                                        if (decodeddata['sender_message_id'].toString() == "$receiverid" ||
                                            decodeddata['receiver_message_id']
                                                    .toString() ==
                                                "$receiverid") {
                                          if (chatconversations.length > 0) {
                                            if ((chatconversations[0]
                                                            .time
                                                            .toString() !=
                                                        decodeddata['time']
                                                            .toString() &&
                                          ...
                                          print("sending notification, senderid(${decodeddata['sender_message_id'].toString()}),receiverid(${decodeddata['receiver_message_id']}) and actually receiver id ($receiverid)");
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                        ...
                                        //                                   12),
                                        //                       child: BlurFilter(
                                        //                         child: p.extension(attachmentfile.path) == ".jpg" ||
