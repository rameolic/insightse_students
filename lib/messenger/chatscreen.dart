                                ...
                                print(decodeddata);
                                  if (decodeddata['sender_message_id']
                                      ...
                                      decodeddata['receiver_message_id']
                                              .toString() ==
                                          "$receiverid") {
                                    if ((chatconversations[0].time.toString() !=
                                                decodeddata['time']
                                                    .toString() &&
                                            chatconversations[0]
                                                    .messagecontent
                                                ...
                                                decodeddata['message']
                                                    .toString()) ||
                                        (chatconversations[0].time.toString() ==
                                                decodeddata['time']
                                                    .toString() &&
                                            chatconversations[0]
                                                    .messagecontent
                                    ...
                                    print("here bro");
                                    await  sendnotification(decodeddata['sender_name']
                                        .toString()+" sent you a message.",decodeddata['message']
                                        .toString().length>25?decodeddata['message']
                                        .toString().substring(0,25)+"..":decodeddata['message']
                                        .toString());
                                  }
                               // }
                                loading.value = false;
                            ...
                            if (chatconversations.length > 0) {
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  if(attachmentfile!=null && chatconversations.length > 0)
                                    ConstrainedBox(
                              ...
                              Expanded(
                                child: Center(
                                child: Text(
                                "Start a conversation by sending a message",style: TextStyle(color: Colors.white),),
                                ),
                              ),
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: TextField(
                                                      ...
                                                      decoration: InputDecoration(
                                                        ...
                                                        hintText:
                                                            socketstatus ? 'Your message here' :"our systems are offline, Try again later.",
                                                        hintStyle: TextStyle(
                                                            color: Colors.white
                                                                .withOpacity(
                                                                    0.5)),
                                                    ...
                                                    onTap: () async {
                                                      if (typedmsg
                                                        ...
                                                        Map body = {
                                                          ...
                                                          "receiver": receiverid,
                                                          "sender":
                                                          Logindata.parentid == null ?"$messengerid":"${Logindata.parentid}",
                                                          "attachment": "",
                                                          "sender_name":
                                                              Logindata.fullname
                                                        };
                                  ...
                                  if(is_bot)
                                    SafeArea(
                                      child: Container(
                                        ...
                                        child: Center(child: Text("Chat is disabled here!",textAlign: TextAlign.center,style: TextStyle(color: Colors.white54,fontSize: 12),)),
                                      ),
                                    ),
                                  if(!canrespond)
                                    SafeArea(
                                      child: Container(
                                        ...
                                        child: Center(child: Text("Only Admins can send messages.",textAlign: TextAlign.center,style: TextStyle(color: Colors.white54,fontSize: 12),)),
                                      ),
                                    )
...
Future getFile() async {
  if (Platform.isAndroid) {
    file = await FilePicker.platform
      ...
      allowedExtensions: ['jpg','mov','jpeg','png','mkv''mp4', 'pdf', 'doc','mov'],
    );
