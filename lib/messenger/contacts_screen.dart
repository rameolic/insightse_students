...
class _ContactsScreenState extends State<ContactsScreen> {
  ...
  final chatloading = new ValueNotifier(false);
  @override
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Text(
                                                                      ...
                                                                      style: TextStyle(
                                                                          fontSize:
                                                                          14.0,
                                                                          color: conversations[index].readstatus.toString() == "0" && conversations[index].senderid.toString() != current_userid
                                                                              ? Colors
                                                                              .black
                                                                              : Colors
                                                                              .grey,
                                                                          fontWeight: conversations[index].readstatus.toString() == "0" && conversations[index].senderid.toString() != current_userid
                                                                              ? FontWeight
                                                                              .bold
                                                                              : FontWeight
                                                                              .normal)),
